    ...
    <>
      ...
      <div className="block md:hidden bg-[#FBFAFA] overflow-hidden">
        <div className="flex flex-col items-center text-center px-4 pt-28 pb-6">
          ...
          <h1 className="text-4xl font-bold tracking-tight mb-6 max-w-4xl text-center">
            Fast, Fair <span className="text-primary">Claims Processing</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mb-8 leading-relaxed text-center">
