        ...
        <ScrollReveal animation="fadeLeft">
          <div className="space-y-5">
            {[
              ...
              <a key={item.label} href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} className="flex items-center gap-4 p-4 rounded-2xl hover:bg-accent/50 hover:translate-x-1 transition-all duration-300 group">
